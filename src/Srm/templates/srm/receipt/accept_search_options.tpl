    ...
    <div class="column">
      <div class="fieldset">
        ...
        <div class="input flex">
          <input type="date" name="issue_date_start" id="issue_date_start" value="{{ post.issue_date_start is empty ? '' : post.issue_date_start|date('Y-m-d') }}" class="datetime grow-1">
          <em>〜</em>
          <input type="date" name="issue_date_end" id="issue_date_end" value="{{ post.issue_date_end is empty ? '' : post.issue_date_end|date('Y-m-d') }}" class="datetime grow-1">
        </div>
      </div>
      <div class="naked">
